...
module.exports = function handleCommands(dir, commands, aliases, scommands) {
    (0, fs_1.readdirSync)((0, path_1.join)(__dirname, dir)).forEach((file) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        var _a, _b;
        if (!file.endsWith('.js')) {
            handleCommands((0, path_1.join)(dir, file), commands, aliases, scommands);
            return;
        }
        ...
        if (command.data)
            scommands.set(command.label, (_b = command.data) === null || _b === void 0 ? void 0 : _b.toJSON());
    }));
};
